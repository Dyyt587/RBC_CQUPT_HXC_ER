 ...
 */
void bldc_interface_uart_init(void(*func)(unsigned char *data, unsigned int len),int handler_num) {
	// Initialize packet handler
	packet_init(func, process_packet, handler_num);
 ...
 */
void bldc_interface_uart_process_byte(unsigned char b,int handler_num) {
	packet_process_byte(b, handler_num);
}
