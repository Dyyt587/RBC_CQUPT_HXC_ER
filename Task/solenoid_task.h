...
#define SOL_3_Push_Ring_Pin GPIO_PIN_4//继电器IN3
#define SOL_3_Push_Ring_GPIO_Port GPIOE

#define SOL_1_Fetch_Ring_Pin GPIO_PIN_0//继电器IN2
#define SOL_1_Fetch_Ring_GPIO_Port GPIOF

#define SOL_2_Lifting_Ring_Pin GPIO_PIN_1//继电器IN1
#define SOL_2_Lifting_Ring_GPIO_Port GPIOB

#define SOL_1_Shot_Pin GPIO_PIN_1//继电器IN4
...
#define Limit_up() HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_4) //上限--》P2
#define Limit_down() HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_5) //下限--》P1
